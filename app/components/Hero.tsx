...
const redWhitePreset = {
  ...
  colors: {
    ...
    rightCars: [0xFFFFFF, 0xF3F4F6, 0xE5E7EB],
    sticks: 0xFF0000,
  }
};
    ...
    >
      <div className="max-w-6xl mx-auto text-center py-16 md:py-24 lg:py-32">
        ...
        <div className="mt-8 max-w-3xl mx-auto relative">
          ...
          <div className="relative w-full min-h-screen bg-gradient-to-br from-black via-slate-950 to-black overflow-hidden font-sans">
